...
namespace Mainx.Controllers
{
    ...
    public class CompaniesController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetCompaniesEmployeesMultipleMappings()
        {
            try
            {
                var company = await _companyRepo.GetCompaniesEmployeesMultipleMapping();
        ...
        // POST: api/company/create-multiple
        ...
        public async Task<IActionResult> CreateMultipleCompanies([FromBody] List<CompanyForCreationDto> companies)
        {
            ...
            catch (Exception ex)
            {
                ...
                // You can also handle and return a specific error response
